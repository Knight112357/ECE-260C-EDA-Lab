...
filtered_insts = [i for i in insts if i.getMaster().getName() == "sg13g2_dfrbp_1"]
target_master = library.findMaster("sg13g2_dfrbp_2")
[i.swapMaster(target_master) for i in filtered_insts]
